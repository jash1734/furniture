...
function home() {
  return (
    <div className='w-full h-fit lg:flex bg-gray-300'>
        ...
        <div  className='w-full h-full flex flex-col justify-center items-center'>
            <div className='h-fit w-full m-4 p-10 flex justify-center items-center'>
                <img className='w-96 h-[450px] border border-black' src="https://res.cloudinary.com/dvvusmrli/image/upload/v1719642058/aat91d5ww3eygxryzyiz.png" alt="" />
